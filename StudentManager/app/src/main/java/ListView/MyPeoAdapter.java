...
public class MyPeoAdapter extends BaseAdapter {
    ...
    public MyPeoAdapter(Context context, ArrayList<User> list){
    ...
    static class ViewHolder{
        ...
        public TextView name,introduction;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.introduction.setText(user.getBranch()+"-"+user.getClassId());
        Glide.with(mContext).load(R.mipmap.person).into(holder.imageView);
        return convertView;
    }
}
